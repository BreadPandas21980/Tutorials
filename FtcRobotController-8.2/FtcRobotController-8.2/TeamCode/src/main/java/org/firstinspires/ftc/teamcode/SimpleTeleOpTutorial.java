...
public class SimpleTeleOpTutorial extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        slide_left = hardwareMap.get(DcMotor.class, "back_left");
        slide_right = hardwareMap.get(DcMotor.class, "back_right");
        arm_left = hardwareMap.get(CRServo.class, "left_arm");
        arm_right = hardwareMap.get(CRServo.class, "right_arm");
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("arm: ", arm_left);
            telemetry.addData("slides: ", slide_left);
            telemetry.update();
        }
    }
